...
public class Competencia {
    ...
    public boolean revisarSiElJuegoContinua(Computadora c, Jugador jActual){
        ...
        if (c.getNumeroBarcos()>0 && jActual.getBarcosJugador().size() > 0) {
            continua = true;
        }
        return continua;
    }
    public String mensajeResultadoAtaqueComputadora(int x, int y, Jugador jActual){
        ...
        int contador=0;
        if (!Objects.equals(jActual.tableroOrigen.tablero[y][x], "_")){
        ...
        } else if (jActual.tableroOrigen.tablero[y][x].equals("_")) {
            mensaje = "AL AGUA";
    ...
    public String mensajeResultadoAtaqueJugador(String coordenadaDeAtaque){
        ...
        if (!Objects.equals(computadora.tableroComputadora.tablero[y][x], "_")){
            if (elemento.equals("*") || elemento.equals("X")){
                System.out.println("Esta coordenada ya fue atacada antes.");
                mensaje = "FRACASADO";
            }else{
        ...
        } else if (computadora.tableroComputadora.tablero[y][x].equals("_")) {
            mensaje = "AL AGUA";
        }
        return mensaje;
    }
